...
<body>
    ...
    <section class="home" id="home">
        ...
        <div class="content">
            ...
            <p>Choose Flower Product Here</p>
    ...
    <section class="category" id="category" name="category">
        ...
        <h1 class="heading"> Flower <span>Product</span> </h1>
            ...
            <ul style="list-style-type: none;" id="myList"
                ...
                <li class="col mb-5">
                    <div class="card h-100">
                        <!-- Product image-->
                        <img class="card-img-top" src="<?= $row['image_url'] ?>" alt="<?= $row['productname'] ?>" />
                        <!-- Product details-->
                        <div class="card-body p-4">
                            <div class="text-center">
                                <!-- Product name-->
                                <h3 class="card-title fw-bolder"><?= $row['productname'] ?></h3>
                                <!-- Product reviews-->
                                <div style="font-size: 15px;"
                                    class="d-flex justify-content-center small text-muted mb-2">
                                    <p><?= $row['productdescription'] ?></p>
                                </div>
                                <!-- Product price-->
                                <h4><label>IDR&nbsp;</label><label>
                                        <?= $row['price'] ?>
                                    </label>/<label>
                                        <?= $row['productunit'] ?></h4>
                            </div>
                        ...
                        <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                            <div class="text-center"><a href="addtocart.php?productID=<?=$row['productID']?>" class="btn btn-outline-dark addtocart mt-auto">Add to
                                    cart</a></div>
                        </div>
                    </div>
                </li>
