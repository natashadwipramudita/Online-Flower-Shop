<?php
    ...
    $category = mysqli_query($con, "SELECT * FROM tbl_category WHERE categoryID = '".$_GET['id']."' ");
...
<body>
    ...
    <section class="addCategory" id="addCategory">
        ...
        <div class="content">
            <h3>Edit <span>Category</span></h3>
            <p>Edit Flower's Category Here</p>
            ...
            <div class="form">
                <form action="" method="POST">
                    ...
                    <div class="form-floating mb-3">
                        <input style="height:50px;font-size: 15px;" type="text" name="name" placeholder="Category Name" class="form-control" value="<?php echo $c->categoryName ?>" required>
                ...
                <?php
                    if (isset($_POST['submit'])) {
                        ...
                        $update = mysqli_query($con,"UPDATE tbl_category SET 
                                                    categoryName = '".$name."'
                        ...
                        if ($update) {
                            ...
                            echo '<script>alert("Fail to Update Category!")</script>' . mysqli_error($con);
                        }
                    }
                ?>
            </div>
