...
<body>
    ...
    <section class="home" id="home">
        ...
        <div class="content">
            <h3>Manage <span>Customer</span></h3>
    ...
    <section class="manage-products" id="manage-products" style="font-size: 15px;">
        <h1 class="heading"> Manage <span>Customer</span> </h1>
        <div align="center" class="container">

            <a align="center" href="add-customer.php" class='col btn btn-cool-blue'>ADD RECORD</a>
            <h6><br><br></h6>
            <table border="1" width="75%" class="table table-hover table-bordered">
                ...
                <?php
                $sql_profile = "SELECT * FROM tbl_customer ORDER BY customerID DESC";
                ...
                if (mysqli_num_rows($result_profile) > 0) {
                    while ($row = mysqli_fetch_array($result_profile)) {
                        ...
                        echo "<td>";
                        echo "<a style='margin-top:0px;' href='edit-customer.php?id=" . $row['customerID'] . "' class='col btn btn-orange-moon'>EDIT</a>";
                        echo "<hr>"; 
                        echo "<a style='margin-top:0px;' href='delete-customer.php?id=" . $row['customerID'] . "' class='col btn btn-pink-moon'>DELETE</a>";
                        echo "</td>";
                        echo "</tr>";
                    }
                }
